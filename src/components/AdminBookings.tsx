...
export function AdminBookings({ bookings, onCancel, cancellingId }: AdminBookingsProps) {
  if (bookings.length === 0) {
    return <div className="px-5 py-10 text-center text-text-muted">Активных записей нет.</div>;
  }
